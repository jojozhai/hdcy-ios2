//
//  YLFamousListSecondTableViewCell.m
//  hdcy
//
...
@implementation YLFamousListSecondTableViewCell
...
-(void)customRect
{
    self.mainImageView=[[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2, 8, SCREEN_WIDTH/2, 100)];
    [self.contentView addSubview:self.mainImageView];
    
    UIImageView *backImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 8, SCREEN_WIDTH/2, 100)];
