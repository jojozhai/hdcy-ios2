...
@implementation YLNewsTopNomalTableViewCell
...
-(void)cusCell{
    ...
    UILabel *topLabel=[[UILabel alloc]initWithFrame:CGRectMake(12, 85*SCREEN_MUTI, 30, 20)];
    topLabel.textColor=[UIColor grayColor];
    topLabel.textAlignment=NSTextAlignmentCenter;
    topLabel.text=@"置顶";
    topLabel.font=FONT_SYS_ANNOTATE;
    [hideImageView addSubview:topLabel];
    
    self.tagLabel=[[UILabel alloc]initWithFrame:CGRectMake(60, 85*SCREEN_MUTI, 60, 20)];
    ...
    self.timeLabel=[[UILabel alloc]initWithFrame:CGRectMake(135, 85*SCREEN_MUTI, 100, 20)];
