//
//  YLNewsListTopAdTableViewCell.m
//  hdcy
//
...
@implementation YLNewsListTopAdTableViewCell
...
-(void)cusCell
{
    ...
    UILabel *adLabel=[[UILabel alloc]initWithFrame:CGRectMake(60, 85*SCREEN_MUTI, 30, 20)];
